...
class GatSession:
    ...
    def load_ifc(
        ...
        """Compile an IFC file into a world.

        ``scope`` restricts lowering to an explicit subject set; everything
        else in the file stays audit-only.  See
        :mod:`gat.adapters.ifc.scope`.
        """
